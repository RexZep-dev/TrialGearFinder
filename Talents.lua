...
ns.TalentCodes = {
    ...
    [255] = {
        code = "C8PAD57yiELKEty14ekTDtZEqAAAAAAwYMADAAAAAADDAwAAAAAAAAAAYwAAAgBAAA",
        note = "Выживание: с Огнебомбой — её берут 83 % игроков (см. оговорку ниже)",
    },
    -- ОГОВОРКА ПО ВЫЖИВАНИЮ. Лучшая по симулятору сборка (253 урона против
    -- 224 у этой) идёт вообще без Огнебомбы, а её в логах берут 83 % игроков —
    -- поэтому взята эта. Проверить самую ходовую сборку, с Огнестрелом
    -- (57 % игроков), нельзя вовсе: симулятор на таких сборках падает.
    -- Это его собственная ошибка, проверено на чистой сборке без наших правок.
