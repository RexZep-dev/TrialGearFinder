...
ns.TalentCodes = {
    ...
    -- ПОЧЕМУ НЕ ЛУЧШАЯ ПО СИМУЛЯТОРУ. Сборки без Огнебомбы дают 253 урона
    -- против 240 у этой, но Огнебомбу берут 83 % игроков, а без неё у спека
    -- остаётся один Удар ящера. Разница 5 % не стоит расхождения с живой игрой.
    -- Огнестрел и Укус мангуста, которые видны в логах, в кнопку не попадут:
    -- по данным игры Огнестрел теперь талант Стрельбы (нужно 8 очков в её
    -- дереве), а Укус мангуста из дерева убран вовсе. Логи записаны раньше.
