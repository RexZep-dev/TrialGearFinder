...
local SOURCE_PINS = {
    ...
    -- Карта 942 = Долина Штормов (подтверждено метками Абсинтии и Мрачноморда),
    -- а в note записан Друствар. Ошибка в note, а не в метке - поправить текст.
    ["item:159518"] = { 942, 53.5, 50.8 }, -- Длинноклык и Генри Брейкуотер
    -- Кул-Тирас, Тирагардское поморье
    ["item:155278"] = { 895, 54.9, 32.7 }, -- Чешуетряс Ядовитый
    ["item:155551"] = { 895, 48.7, 36.7 }, -- Сквиргл-из-Глубин
    ["item:155571"] = { 895, 62.1, 51.7 }, -- сундук за Стража источника (Чалый Бертольд)
    ["item:158597"] = { 895, 48.6, 22.9 }, -- Кулетт Вспыльчивый
    ["item:160451"] = { 895, 76.6, 83.6 }, -- Бармен Билл
    -- Кул-Тирас, Долина Штормов
    ["item:155164"] = { 942, 62.0, 56.9 }, -- Сестра Абсинтия
    ["item:155572"] = { 942, 62.5, 73.9 }, -- Мрачноморд Безмозглый
    -- Кул-Тирас, Боралус (метка на карте Тирагарда, город виден на ней же)
    ["item:155273"] = { 895, 76.9, 29.9 }, -- Пилозуб
    -- Зандалар, Зулдазар
    ["item:160952"] = { 862, 74.6, 39.6 }, -- Кинжалозуб
    ["item:160958"] = { 862, 65.2, 10.2 }, -- Темноуст Джола
    ["item:160978"] = { 862, 42.2, 36.1 }, -- Хакби Восставший
    ["item:160984"] = { 862, 68.7, 48.8 }, -- Кандак
}
