...
local ACTIONS = {
    ...
    [254] = { -- Стрельба: Быстрая стрельба, Прицельный, Чародейский, Верный выстрел.
              ...
              -- из них 98 % даёт автовыстрел. Своя — 639 (18 сентября, цель 45,
              -- сборка Снайперюльки с армори). Состав сверен с логами гильдии:
              ...
              -- нашей (253 и 325 против 253 и 279), им строк не пишем.
        "actions=auto_shot",
        "actions+=/rapid_fire",
        "actions+=/aimed_shot",
