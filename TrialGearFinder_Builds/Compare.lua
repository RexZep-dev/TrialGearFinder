...
local function Build()
    ...
    frame:SetFrameStrata("MEDIUM") -- как основное окно и карта мира: наверху то, по чему щёлкнули
    frame:SetClampedToScreen(true)
    -- Щелчок поднимает окно над основным, как и основное над ним: оба
    -- в одном слое MEDIUM, и открытое кнопкой «Сравнить» окно оказывалось
