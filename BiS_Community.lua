...
ns.CommunityItems = {
    ...
    { itemID = 24387, bonusIDs = { 6710, 6652 }, classes = { "DEATHKNIGHT", "PALADIN", "WARRIOR" }, sourceType = "Dungeon", source = "уточнить", note = "Рукавицы Железного лезвия: латные кисти на крит (слепок, ×6)", ilvl = 23, armor = 15, sockets = 2, socketTypes = { "prismatic", "prismatic" }, socketBonus = nil, stats = { str = 5, int = 5, stam = 7, crit = 10 } },
    { itemID = 34612, bonusIDs = { 6710, 6652 }, classes = { "DEATHKNIGHT", "PALADIN", "WARRIOR" }, sourceType = "Dungeon", source = "уточнить", note = "Наголенники кающегося рыцаря: латные ступни на универсальность (слепок, ×7)", ilvl = 23, armor = 14, sockets = 2, socketTypes = { "prismatic", "prismatic" }, socketBonus = nil, stats = { str = 5, int = 5, stam = 7, vers = 5 } },
    { itemID = 30538, bonusIDs = { 6710, 6652 }, classes = { "DEMONHUNTER", "ROGUE", "MONK", "DRUID" }, sourceType = "Dungeon", source = "уточнить", note = "Полуночные набедренники: кожаные ноги на крит/скорость, 3 гнезда (слепок, ×5)", ilvl = 23, armor = 9, sockets = 3, socketTypes = { "prismatic", "prismatic", "prismatic" }, socketBonus = nil, stats = { agi = 7, int = 7, stam = 10, crit = 7, haste = 4 } },
    { itemID = 188465, bonusIDs = { 6710, 6652 }, classes = { "DRUID", "MONK", "HUNTER" }, sourceType = "Dungeon", source = "уточнить", note = "Хребет разлагающегося трупа: агиловый посох, у друида-кота (слепок, ×4)", ilvl = 32, armor = nil, sockets = 0, socketTypes = {  }, socketBonus = nil, stats = { agi = 7, stam = 11, crit = 7, haste = 8 } },
    { itemID = 178826, bonusIDs = { 6710, 6652 }, classes = nil, sourceType = "Dungeon", source = "уточнить", note = "[ДД] Аметист крови солнца: тринька на чистую скорость (слепок, ×5)", ilvl = 23, armor = nil, sockets = 0, socketTypes = {  }, socketBonus = nil, stats = { haste = 9 } },
}
