...
ns.CommunityItems = {
    ...
    -- был не выяснен ("уточнить"); последние 13 закрыты 24 сентября по Wowhead
    -- (раздел «Добыча с»).
    -- 24 сентября убраны 13 шей и колец 23 уровня с 18-19 вторичками: рядом
    -- вещи Путешествия во времени с 20-21 (пользователь). Амнезия оставлена -
    -- её носят с тремя гнёздами. Вернутся в прогрессию шмота, когда её сделаем.
    ...
    { itemID = 113082, bonusIDs = { 6710, 6652 }, classes = nil, sourceType = "World", source = "Долина Призрачной Луны", note = "Драгоценная петля из кровошипа: берут ради эффекта (шипы и незаметность), BiS - любая копия; с Горума (слепок: 17 копий 23 ур. без гнезда)", anyCopy = true, ilvl = 23, armor = nil, sockets = 0, socketTypes = {  }, socketBonus = nil, stats = { str = 4, agi = 4, int = 4, stam = 4, vers = 6 } },
    ...
    { itemID = 9477, bonusIDs = { 6710, 6652 }, classes = { "MONK", "DRUID" }, sourceType = "Dungeon", source = "Зул'Фаррак", note = "падает с Вождя Укорза Песчаного Черепа; Головорез вождя: двуручный посох на ловкость, уровень 23", ilvl = 23, armor = nil, sockets = 0, socketTypes = {  }, socketBonus = nil, stats = { agi = 7, stam = 10, crit = 9, vers = 4 } },
    { itemID = 110040, bonusIDs = { 6710, 4746, 40 }, classes = { "HUNTER", "MONK", "DRUID" }, sourceType = "Dungeon", source = "Шлаковые шахты Кровавого Молота", note = "падает с Надсмотрщика за рабами Крушто; Обезглавливатель Крушто: двуручное древковое на ловкость", ilvl = 23, armor = nil, sockets = 0, socketTypes = {  }, socketBonus = nil, stats = { agi = 7, stam = 10, crit = 7, iskus = 6 } },
    { itemID = 110058, bonusIDs = { 6710, 4746, 6652 }, classes = { "WARRIOR", "HUNTER", "ROGUE", "SHAMAN", "MONK", "DRUID", "DEMONHUNTER" }, sourceType = "Dungeon", source = "Железные доки", note = "падает с Черепона; Окровавленная рука горести: одноручное кистевое на ловкость", ilvl = 23, armor = nil, sockets = 0, socketTypes = {  }, socketBonus = nil, stats = { agi = 3, stam = 5, vers = 3, iskus = 3 } },
    ...
    { itemID = 109868, bonusIDs = { 6710, 4746, 6652, 8810 }, classes = { "DEMONHUNTER", "ROGUE", "MONK", "DRUID" }, sourceType = "Dungeon", source = "Подземелья Дренора", note = "Наручи огненной собранности: кожаные запястья, одно гнездо. Случайная добыча в подземельях Дренора (Крушто, Нхаллиш, Аззакель) и в тайниках, 1,5-3%", ilvl = 23, armor = 5, sockets = 1, socketTypes = { "prismatic" }, socketBonus = nil, stats = { agi = 4, int = 4, stam = 6, crit = 4, iskus = 3 } },
    { itemID = 37853, bonusIDs = { 6710, 6652, 8810 }, classes = { "DEMONHUNTER", "ROGUE", "MONK", "DRUID" }, sourceType = "Dungeon", source = "Чертоги Молний", note = "падает с Локена; Улучшенные поручи из выделанной кожи: кожа, уровень 23, одно гнездо", ilvl = 23, armor = 5, sockets = 1, socketTypes = { "prismatic" }, socketBonus = nil, stats = { agi = 4, int = 4, stam = 6, haste = 5 } },
    { itemID = 127521, bonusIDs = { 13828, 7756 }, classes = { "DEMONHUNTER", "ROGUE", "MONK", "DRUID" }, sourceType = "Dungeon", source = "Путешествие во времени: Нордскол", note = "падает с Локена (Чертоги Молний); те же Улучшенные поручи, версия Путешествия во времени, уровень 32, без гнезда", ilvl = 32, armor = 6, sockets = 0, socketTypes = {  }, socketBonus = nil, stats = { agi = 4, int = 4, stam = 6, haste = 8 } },
    { itemID = 109879, bonusIDs = { 6710, 6652, 8812 }, classes = { "DEATHKNIGHT", "PALADIN", "WARRIOR" }, sourceType = "Dungeon", source = "Подземелья Дренора", note = "Наручи Кишкодава: латные запястья, без гнезда. Случайная добыча в подземельях Дренора (Крушто, Нхаллиш, Аззакель) и в тайниках, 1-3%", ilvl = 23, armor = 11, sockets = 0, socketTypes = {  }, socketBonus = nil, stats = { str = 4, int = 4, stam = 6, vers = 3, iskus = 4 } },
    ...
    { itemID = 188444, bonusIDs = { 13828, 7756 }, classes = { "DEMONHUNTER", "ROGUE", "MONK", "DRUID" }, sourceType = "Dungeon", source = "Путешествие во времени: Нордскол", note = "падает со Скарвальда Строителя (Крепость Утгард); Наручники проходчика: кожа, Путешествие во времени, уровень 32. Шанс мал, 0,2%", ilvl = 32, armor = 6, sockets = 0, socketTypes = {  }, socketBonus = nil, stats = { agi = 4, int = 4, stam = 6, crit = 4, vers = 5 } },
    ...
    { itemID = 109995, bonusIDs = { 6710, 4746, 6652 }, classes = { "DEMONHUNTER", "ROGUE", "MONK", "SHAMAN", "DRUID" }, sourceType = "Dungeon", source = "Аукиндон", note = "падает с Аззакеля; Кровавая печать Аззакеля: аксессуар на ловкость и крит", ilvl = 23, armor = nil, sockets = 0, socketTypes = {  }, socketBonus = nil, stats = { agi = 6, crit = 9 } },
    { itemID = 110009, bonusIDs = { 6710, 6652 }, classes = nil, sourceType = "Dungeon", source = "Вечное Цветение", note = "падает с Дулгу и других в Вечном Цветении; Лист древних защитников: аксессуар на искусность, по использованию щит на союзника", ilvl = 23, armor = nil, sockets = 0, socketTypes = {  }, socketBonus = nil, stats = { iskus = 9 } },
    ...
    { itemID = 110045, bonusIDs = { 6710, 4746, 6652 }, classes = { "WARLOCK", "EVOKER", "MONK", "SHAMAN", "DRUID", "PRIEST", "MAGE" }, sourceType = "Dungeon", source = "Аукиндон", note = "падает с Дозорного Каатара; Кристаллический волшебный посох Камуи: двуручный, интеллект 30", ilvl = 23, armor = nil, sockets = 0, socketTypes = {  }, socketBonus = nil, stats = { int = 30, stam = 10, vers = 7, iskus = 6 } },

    -- Инженерные очки Пандарии, все семь (пользователь 26 сентября, скриншоты
    -- подсказок): 5 к основной, 8 выносливости, бонус гнёзд +2; армори сходится
    -- на лёгких и латных (5/8). Номера и бонус гнёзд - из дампа simc.
    { itemID = 77533, bonusIDs = { 7175 }, classes = { "MAGE", "PRIEST", "WARLOCK" }, sourceType = "Craft", source = "Инженерия", note = "крафт (инженерия Пандарии, надеть может только инженер); Легкая ретинальная защита: тканевый шлем, особое гнездо и два для зубчатого колеса", ilvl = 18, armor = 4, sockets = 3, socketTypes = { "meta", "cogwheel", "cogwheel" }, socketBonus = { key = "int", value = 2 }, stats = { int = 5, stam = 8 } },
    { itemID = 77535, bonusIDs = { 7175 }, classes = { "DEMONHUNTER", "DRUID", "MONK", "ROGUE" }, sourceType = "Craft", source = "Инженерия", note = "крафт (инженерия Пандарии, надеть может только инженер); Маскировочная ретинальная защита: кожаный шлем, особое гнездо и два для зубчатого колеса", ilvl = 18, armor = 7, sockets = 3, socketTypes = { "meta", "cogwheel", "cogwheel" }, socketBonus = { key = "int", value = 2 }, stats = { agi = 5, int = 5, stam = 8 } },
    { itemID = 77534, bonusIDs = { 7175 }, classes = { "DEMONHUNTER", "DRUID", "MONK", "ROGUE" }, sourceType = "Craft", source = "Инженерия", note = "крафт (инженерия Пандарии, надеть может только инженер); Подвижная ретинальная защита: кожаный шлем, особое гнездо и два для зубчатого колеса", ilvl = 18, armor = 7, sockets = 3, socketTypes = { "meta", "cogwheel", "cogwheel" }, socketBonus = { key = "agi", value = 2 }, stats = { agi = 5, int = 5, stam = 8 } },
    { itemID = 77537, bonusIDs = { 7175 }, classes = { "EVOKER", "HUNTER", "SHAMAN" }, sourceType = "Craft", source = "Инженерия", note = "крафт (инженерия Пандарии, надеть может только инженер); Заряженная ретинальная защита: кольчужный шлем, особое гнездо и два для зубчатого колеса", ilvl = 18, armor = 10, sockets = 3, socketTypes = { "meta", "cogwheel", "cogwheel" }, socketBonus = { key = "int", value = 2 }, stats = { agi = 5, int = 5, stam = 8 } },
    { itemID = 77536, bonusIDs = { 7175 }, classes = { "EVOKER", "HUNTER", "SHAMAN" }, sourceType = "Craft", source = "Инженерия", note = "крафт (инженерия Пандарии, надеть может только инженер); Смертоносная ретинальная защита: кольчужный шлем, особое гнездо и два для зубчатого колеса", ilvl = 18, armor = 10, sockets = 3, socketTypes = { "meta", "cogwheel", "cogwheel" }, socketBonus = { key = "agi", value = 2 }, stats = { agi = 5, int = 5, stam = 8 } },
    { itemID = 77538, bonusIDs = { 7175 }, classes = { "DEATHKNIGHT", "PALADIN", "WARRIOR" }, sourceType = "Craft", source = "Инженерия", note = "крафт (инженерия Пандарии, надеть может только инженер); Специализированная ретинальная защита: латный шлем, особое гнездо и два для зубчатого колеса", ilvl = 18, armor = 15, sockets = 3, socketTypes = { "meta", "cogwheel", "cogwheel" }, socketBonus = { key = "int", value = 2 }, stats = { int = 5, str = 5, stam = 8 } },
