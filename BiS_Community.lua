...
ns.CommunityItems = {
    ...
    -- Шеи
    { itemID = 200210, bonusIDs = { 6710, 6652 }, classes = nil, sourceType = "World", source = "Лазурный Простор", note = "падает с рарника Forgotten Creation; Амнезия: шея на скорость/универсальность, 3 гнезда (слепок, ×45 — самая ходовая)", ilvl = 23, armor = nil, sockets = 3, socketTypes = { "prismatic", "prismatic", "prismatic" }, socketBonus = nil, stats = { stam = 6, haste = 10, vers = 8 } },
    ...
    { itemID = 200446, bonusIDs = { 6710, 6652 }, classes = nil, sourceType = "World", source = "Равнины Он'ары", note = "падает с рарника Liskheszaera; Кристаллизованная печать: шея на универсальность/искусность, 3 гнезда (слепок, ×12)", ilvl = 23, armor = nil, sockets = 3, socketTypes = { "prismatic", "prismatic", "prismatic" }, socketBonus = nil, stats = { stam = 6, vers = 8, iskus = 10 } },
    { itemID = 200207, bonusIDs = { 6710, 6652 }, classes = nil, sourceType = "World", source = "Берега Пробуждения", note = "падает с рарника Morchok; Окаменевшие споры грибов: шея на скорость/универсальность, 3 гнезда (слепок, ×8)", ilvl = 23, armor = nil, sockets = 3, socketTypes = { "prismatic", "prismatic", "prismatic" }, socketBonus = nil, stats = { stam = 6, haste = 9, vers = 9 } },
    { itemID = 193809, bonusIDs = { 6710, 6652 }, classes = nil, sourceType = "Dungeon", source = "Ульдаман: наследие Тира", note = "падает с Бромача; Выкопанный медальон Бромача: шея на скорость/искусность, 3 гнезда (слепок, ×6)", ilvl = 22, armor = nil, sockets = 3, socketTypes = { "prismatic", "prismatic", "prismatic" }, socketBonus = nil, stats = { stam = 5, haste = 13, iskus = 5 } },
    { itemID = 188471, bonusIDs = { 6710, 6652 }, classes = nil, sourceType = "Dungeon", source = "Кузня Душ", note = "падает с Пожирателя Душ; Ожерелье из пропавших камней: шея на крит/скорость (слепок, ×7)", ilvl = 23, armor = nil, sockets = 1, socketTypes = { "prismatic" }, socketBonus = nil, stats = { stam = 6, crit = 11, haste = 10 } },
    ...
    { itemID = 178826, bonusIDs = { 6710, 6652 }, classes = nil, sourceType = "Dungeon", source = "Чертоги Покаяния", note = "падает с верховного адъюдикатора Ализы; [ДД] Аметист крови солнца: тринька на чистую скорость (слепок, ×5)", ilvl = 23, armor = nil, sockets = 0, socketTypes = {  }, socketBonus = nil, stats = { haste = 9 } },
}
