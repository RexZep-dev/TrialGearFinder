...
ns.CommunityItems = {
    ...
    { itemID = 134487, bonusIDs = { 6710, 8810 }, classes = nil, sourceType = "Dungeon", source = "Чаща Темного Сердца", note = "падает с Верховного друида Глайдалиса; Оскверненная печать верховного друида: кольцо на скорость/искусность, одно гнездо", ilvl = 23, armor = nil, sockets = 1, socketTypes = { "prismatic" }, socketBonus = nil, stats = { stam = 6, haste = 5, iskus = 13 } },
    { itemID = 162544, bonusIDs = { 6710, 6652, 8810 }, classes = nil, sourceType = "Dungeon", source = "Храм Сетралисс", note = "падает с Меректы; Нефритовый перстень змея: кольцо на универсальность/искусность, одно гнездо", ilvl = 23, armor = nil, sockets = 1, socketTypes = { "prismatic" }, socketBonus = nil, stats = { stam = 6, vers = 7, iskus = 12 } },
